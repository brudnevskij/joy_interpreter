...
#genPerms((1, (2, None)))
# genPerms((1, (2, (3, None))))
# count(genPerms((1, (2, (3, (4, None))))))
# count(genPerms((1, (2, (3, (4, (5, None)))))))
# count(genPerms((1, (2, (3, (4, (5, (6, None))))))))
count(genPerms((1, (2, (3, (4, (5, (6, (7, None)))))))))
# count(genPerms((1, (2, (3, (4, (5, (6, (7, (8, None))))))))))
gc.collect()
# print("done")
